...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
    ...
    let navigation_controller = window!.rootViewController as! UINavigationController
    let currentLocationViewController = navigation_controller.viewControllers[0] as! CurrentLocationViewController
  ...
  func customizeAppearance() {
    // configures UINavigationBar's appearance by setting top bar to black
    // ----------------------------------------------------------------------
